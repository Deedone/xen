...
extern void gicv4_its_vpeid_allocator_init(void);
extern int gicv4_init_vpe_proxy(void);
...
#define gits_write_vpropbaser(v, c)     {printk("WRITE VPROPBASER %lx\n", v);writeq_relaxed(v, c);}
