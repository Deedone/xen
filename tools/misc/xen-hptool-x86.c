...
static int hp_mem_online_func(int argc, char *argv[], xc_interface *xch)
{
    uint32_t status;
    int ret;
    unsigned long mfn;
...
static int hp_mem_query_func(int argc, char *argv[], xc_interface *xch)
{
    uint32_t status;
    int ret;
    unsigned long mfn;
...
static int hp_mem_offline_func(int argc, char *argv[], xc_interface *xch)
{
